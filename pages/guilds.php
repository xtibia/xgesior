	...
	else
	{
		...
		<td class=\"white\" align=\"center\">";
			switch($war['status'])
			{
				case 0:
				{
					$main_content .= "<font color=black><b>Pending acceptation</b><br />Invited on " . date("M d Y, H:i:s", $war['started']) . " for 7 days war.<br />";
					if($guild_leader && $war['guild2'] == $guild->getID())
					{
						$main_content .= '<br /><a href="?subtopic=guilds&action=guildwar_invitation_accept&guild=' . $guild_id . '&war=' . $war['id'] . '" onclick="return confirm(\'Are you sure that you want ACCEPT that invitation for 7 days war?\');" style="cursor: pointer;">&raquo; Click here to <span style="color: lime;">accept</span> invitation to war &laquo;</a>';
						$main_content .= '<br /><br /><a href="?subtopic=guilds&action=guildwar_invitation_reject&guild=' . $guild_id . '&war=' . $war['id'] . '" onclick="return confirm(\'Are you sure that you want REJECT that invitation for 7 days war?\');" style="cursor: pointer;">&raquo; Click here to <span style="color: darkred;">reject</span> invitation to war &laquo;</a>';
					}
					if($guild_leader && $war['guild1'] == $guild->getID())
					{
						$main_content .= '<br /><br /><a href="?subtopic=guilds&action=guildwar_invitation_cancel&guild=' . $guild_id . '&war=' . $war['id'] . '" onclick="return confirm(\'Are you sure that you want CANCEL that invitation for 7 days war?\');" style="cursor: pointer;">&raquo; Click here to <span style="color: darkred;">cancel</span> invitation to war &laquo;</a>';
					}
					$main_content .= '</font>';
					break;
				}
